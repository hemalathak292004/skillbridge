...
export default function StudentSignup() {
  ...
  return (
    <AuthLayout title="Create Student Account" subtitle="Join and start learning">
      <form className="sb-form" onSubmit={onSubmit}>
        ...
        <button className="sb-btn primary w-full" type="submit">Create Account</button>
        <p className="sb-muted center">Already have an account? <Link to="/student/login">Log in</Link></p>
      </form>
    </AuthLayout>
  )
} 
